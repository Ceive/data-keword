...
use Ceive\Util\TransientInterface;
...
abstract class Pool implements TransientInterface , NamedInterface{
	 ...
	 * @param Keword $key
	 */
	public function push(Keword $key){
	...
	public function get($identifier){
		if($identifier instanceof Keword){
	...
	/**
	 * Commit all changes for each Keword instance in pool collection if have dirty state
	 */
