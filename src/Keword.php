 ...
 *
 */
abstract class Keword implements TransientInterface , \Serializable{
	...
	public function compareIdentifiersWith($with){
		return $this->getPool()->compareIdentifiers($this->getIdentifier(),$with instanceof Keword?$with->getIdentifier() :$with);
	}
	 ...
	 * @param Keword $instance
	 * @return array
	 */
	public static function instanceToData(Keword $instance){
		return array_merge([
		...
		if(isset($data['class'])){
			...
			if(!is_a($class, __CLASS__, true)){
				throw new \LogicException(
					'Keword::fromPacked Class "' . $class . '" must be instance of ' . __CLASS__ . ''
				);
			}

			if(!class_exists($class, true)){
				throw new \LogicException('Keword::fromPacked Class "' . $class . '" not found');
			}
			$instance = new $class();
